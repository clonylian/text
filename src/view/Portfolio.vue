        ...
        <div class="pro_top">
            ...
            <div class="por_but">
                <router-link to="/wallet">
                    <p class="por_but1">链接一个新的钱包</p>
                </router-link>
                <router-link to="/wallets">
                    <p class="por_but2">链接现有的钱包</p>
                </router-link>
            </div>
        </div>
        <Foot></Foot>
...
.por_box::-webkit-scrollbar {
    width: 0.625rem;
    height: 0.625rem;
}

.por_box::-webkit-scrollbar-track {
    background: transparent;
    border-radius: 2px;
}

.por_box::-webkit-scrollbar-thumb {
    background: rgba(117, 123, 208, 0.2);
    border-radius: 10px;
}

.por_box::-webkit-scrollbar-corner {
    background: transparent;
}

.por_box::-webkit-scrollbar-thumb:hover {
